        ...
        [
            ...
            html.Ul(
                [
                    html.Li(
                        html.A(
                            "Why is data only available for certain timeframes?",
                            href="#before-data-faq",
                        )
                    ),
                            ...
                            html.Ul(
                                [
                                    html.Li(
                                        html.A(
                                            "Participation",
                                            href="#participation-method",
                                        )
                                    ),
                                    html.Li(
                                        html.A("Attendance", href="#attendance-method")
                                    ),
                                    html.Li(
                                        html.A("Speeches", href="#speeches-method")
                                    ),
                                    html.Li(
                                        html.A(
                                            "Readability", href="#readability-method"
                                        )
                                    ),
                                    html.Li(
                                        html.A("Questions", href="#questions-method")
                                    ),
                                ]
                            ),
                        ]
    ...
    main_content = html.Div(
        [
            ...
            html.P(
                [
                    dcc.Markdown(
                        f"Bills are passed to GPT's 4o-mini model and summarized into an output containing an introduction, key points, and direct impacts on citizens. As with the policy positions, indexing and querying of related bills is performed using a RAG method and GPT's `text-embedding-3-small` model. "
                    ),
                ]
            ),
            ...
            html.Br(),
            html.H3(
                "Participation", id="participation-method", style={"marginLeft": "20px"}
            ),
            html.P(
                [
            ...
            html.H3(
                "Readability", id="readability-method", style={"marginLeft": "20px"}
            ),
            html.P(
                "To assess how readable a speech is, we use the Flesch-Kincaid score, a widely used index for measuring how difficult a text is to understand in English. The formula is as follows:",
                style={"marginLeft": "20px"},
            ),
            html.P(
                dcc.Markdown(
                    r"$$206.835 - 1.015 \left( \frac{\text{total words}}{\text{total sentences}} \right) - 84.6 \left( \frac{\text{total syllables}}{\text{total words}} \right)$$",
                    mathjax=True,
                ),
                style={"textAlign": "center"},
            ),
            html.P(
                "The index scales from 0 to 100, with 0 indicating extremely difficult and 100 very easy. Generally, a score of between 30-50 is a college level text, while 10-30 is college-graduate level. Members who did not speak do not have a readability score and will not appear on the graph. Vernacular speeches are also not given a readability score since the index only works for English.",
                style={"marginLeft": "20px"},
            ),
        ...
        dbc.Row(
            [
                ...
                dbc.Col(
                    ...
                    style={
                        "marginTop": "20px"
                    },  # Optional: add some top margin on small screens
                ),
            ],
            align="start",
            justify="start",
