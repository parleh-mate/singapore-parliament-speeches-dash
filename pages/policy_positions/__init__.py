            ...
            dbc.Accordion(
                [
                    dbc.AccordionItem(
                        [
                            html.P(f"""
                                   Summaries are generated by querying the {top_k_rag_policy_positions} most relevant pre-summarized speeches to the user's query and summarizing again using GPT. Please refer to the methodology section for more info.""")
                        ],
                        title=html.Span(
